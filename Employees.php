...
<div class="row rowForm">
	<div class="col-md-8 col-md-offset-2">
		<div class="form-group">
			...
			<a href="functions/LoginHandler.php?logout" class="btn btn-danger">Logout</a>
			<a href="AddEmployee.php" class="btn btn-success" style="float: right;">Add New Employee</a>
